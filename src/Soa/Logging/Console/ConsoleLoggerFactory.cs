...
namespace Soa.Logging.Console
{
...
#endif
    {
        ...
        public ILogger Create(string name)
        {
            ...
            return new Castle.Core.Logging.ConsoleLogger(name);
        }

        public ILogger Create(Type type, LoggerLevel level)
        {
            return new Castle.Core.Logging.ConsoleLogger(type.Name, level);
        }

        public ILogger Create(string name, LoggerLevel level)
        {
            return new Castle.Core.Logging.ConsoleLogger(name, level);
        }
    }
}